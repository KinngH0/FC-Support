...
## 프로젝트 소개
FC Support는 FIFA Online 4의 랭킹 데이터를 수집하고 분석하여 팀컬러별, 랭킹별 통계 정보를 제공하는 서비스입니다. 실시간 랭킹 데이터를 기반으로 메타 분석을 제공하며, 향후 선수 추천 및 전술 분석 기능을 추가할 예정입니다.
...
## 시스템 아키텍처
1. **데이터 수집 시스템**
   - 비동기 크롤러를 통한 실시간 데이터 수집
   - A/B 테이블 전환 방식으로 안정적인 데이터 관리
   - 배치 처리로 효율적인 데이터 수집
